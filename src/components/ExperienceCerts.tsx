...
import { Briefcase, ChevronRight, Award, CheckCircle } from "lucide-react";
    ...
    >
      <SectionHeader
        ...
        title={
          <>
            Leading the{" "}
            <span className="text-gradient-electric italic">placement drive</span>.
          </>
        }
      />
  ...
  return (
    ...
    >
      <SectionHeader
        ...
        title={
          <>
            Verified <span className="text-gradient-electric italic">knowledge</span>.
          </>
        }
      />
